...
def read_commands():
    ...
    retr_count = 0          # number of valid RETR commands processed
            ...
            if command_name in expected_commands:                                # check expected commands
                ...
                if result != "ok":
                    ...
                    if (ord(command[-1]) == lf and 
                        ...
                        elif command_name == "RETR": # RETR can now move file
                            retr_count += 1
                            shutil.copy(pathname, "retr_files/file" + str(retr_count))
                            sys.stdout.write("250 Requested file action completed.\r\n")
                        elif command_name == "TYPE":
                            sys.stdout.write("200 Type set to " + current_type + ".\r\n")
                        elif command_name == "PORT":
                            sys.stdout.write("200 Port command successful (" + host_address + "," + port_number + ").\r\n")
                    else: # incorrect CRLF
